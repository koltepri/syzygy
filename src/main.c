...
int main(void) { 
  ...
  Texture2D background = LoadTexture("Images/Background_Board_sketch.png");     
  ...
  Light light1 = Light_Create(screenWidth / 2,screenHeight / 2); 
  Obstacle obstacles[] = {
  ...
  BeginDrawing(); 
    ...
    //Light_Draw(&light1, obstacles,count); 
    for (int i = 0; i < count; i++) {
